...
if __name__ == '__main__':
    ...
    savePath = '/home/wen/AB3DMOT/scripts/results/sensorfusion/csv_wCR/allset_w3CR_CD_' + str(Test_v) + '.csv'
            ...
            #for rlC in range(len(rng_thres)):
                #for rlD in range(len(rng_thres)):
                   #for rlE in range(len(rng_thres)):
                        #for max_age in range(3,5):
                            #for min_hits in range(3,4):
            print (rlB)
            rlC = 2  #rlC 2 for ALL but 4 for vehicles D:
            rlD =  0
            rlE = 0
            min_hits = 4
            max_age = 3
